...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/py2vega-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7499&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/py2vega-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `py2vega` can be installed with:

```
conda install py2vega
```

It is possible to list all of the versions of `py2vega` available on your platform with:
